...
with EventListener;              use EventListener;
...
package OS is
   ...
   type Wimp_EventListener (E : Reason_Event_Code_Type;
                            W : Wimp_Handle_Type;
                            I : Icon_Handle_Type) is abstract new

             EventListener.Event_Listener(Wimp) with
   record
   ...
   type Message_EventListener (E : Message_Event_Code_Type) is abstract new
          EventListener.Event_Listener(Message) with
   record
   ...
   EventListener.Event_Listener(Toolbox) with
   record      
